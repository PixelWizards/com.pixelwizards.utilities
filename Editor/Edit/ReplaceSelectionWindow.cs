...
namespace PixelWizards.Utilities
{
    public class ReplaceSelectionWindow : EditorWindow
    {
        ...
        private static bool keepOriginals = true;
        ...
        private void OnGUI()
        {
            GUILayout.BeginVertical();
            {
                ...
                keepOriginals = EditorGUILayout.Toggle("Keep Original Objects?", keepOriginals);
        ...
        private void DoReplacement()
        {
            ...
            for(var i = 0; i <selectionTransforms.Length; i++)
            {
                ...
                if (!applyChangesInChildren) continue;
